...
print("""Choose you combo:

""" + dsy + """

\33[44m  """ + str(say) + """ Combos on you list... 
""")

dsyno = str(input(" \33[36m Combo No =\33[0m"))
say=0
for files in os.listdir (dir):
	#if files.endswith(".txt"):
	say=say+1
...
def yaz(kullanici): 
    dosya=open('/sdcard/hits/🅲🆁🆈🌀🆃🅰🅻-🅱🅻🅰🅲🅺🥁𝟕/'	+fx+'.txt','a+')
...
def echox(user,pas,bot,fyz,oran,hit):
	...
	echo=("""	
			                        🌀█▓▒░░𝕄𝟛𝕌📚𝕊ℂ𝔸ℕ𝔼ℝ░░▒▓█🌀  
╭➤ \33[36 █▓▒░░🥁CRYSTALBLACK-7🥁░░▒▓█
├➤ \33[1;32m\33[33m 💻 ֆɛʀʋɛʀ-m3u:\33[0m\33[1;36m"""+portal+""" \33[0m    
├➤ \33[0m\033[1m 📚 𝐔𝐬𝐞𝐫/𝐏𝐚𝐬𝐬:"""+user+""":"""+pas+"""
├➤ \33[36m 👑 Hit➤🔥"""+str(hit)+"""🔥    \33[32m\033[0m\33[1;32m   %"""+str(oran)+"""  \33[1;36mCPM➤"""+str(cpm)+"""  \33[0m
├➤ \33[33m 📕 """+str(dsyno)+str(dosyaa)+""" 
